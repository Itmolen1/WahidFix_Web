                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="add_new_subservice" action="<?php echo base_url().$action?>" method="post">
                        <div class="box-body">
                            ...
                            <?php 
                                if(isset($existing_rights)){
                            	$newarray=array();
                            	for($i=0;$i<count($existing_rights);$i++)
                            	{
                            		$newarray[$existing_rights[$i]['module_id']]=$existing_rights[$i];
                            	}
                            ...
                            <?php if(isset($existing_rights)) { ?><input type="hidden" name="update" id="update" value="update"><?php } ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <?php 
                                        if(isset($existing_rights) && array_key_exists($mode['module_name'], $newarray)) 
                                        { 
                                            if($newarray[$mode['module_name']]['p_view']==1)  
                                            {    
                                                echo "checked"; 
                                            } 
                                        } 
                                        ...
                                        if( isset($existing_rights) && array_key_exists($mode['module_name'], $newarray)) 
                                        { 
                                            if($newarray[$mode['module_name']]['p_add']==1)  
                                            {    
                                                echo "checked"; 
                                            } 
                                        } 
                                        ...
                                        if( isset($existing_rights) && array_key_exists($mode['module_name'], $newarray)) 
                                        { 
                                            if($newarray[$mode['module_name']]['p_update']==1)  
                                            {    
                                                echo "checked"; 
                                            } 
                                        } 
                                        ...
                                        if( isset($existing_rights) && array_key_exists($mode['module_name'], $newarray)) 
                                        { 
                                            if($newarray[$mode['module_name']]['p_delete']==1)  
                                            {    
                                                echo "checked"; 
                                            } 
                                        } 
