    ...
    <section class="content-header">
      <h1>
        ...
        <small><?php 
                    ...
                    {
                        echo "Assign"; } ?> Service Request</small>
              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Assign Service Request</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    ...
                    <form role="form" id="addNewservice" action="<?php echo base_url().$action?>" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="service_id">Requested services</label>
                                        <ol>
                                            <?php 
                                                for($i=0;$i<count($result);$i++)
                                                {
                                                    ?>
                                                    <li><?php echo $result[$i]['service_name']; ?></li>
                                                    <?php 
                                                }
                                            ?>
                                        </ol>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="fname">Order Ref #</label>
                                        <input type="text" class="form-control required" value="<?php echo isset($sr['service_request_ref']) ? $sr['service_request_ref'] : ""; ?>" id="service_request_ref" name="service_request_ref" maxlength="200" readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="assigned_emp_id">Select Employee from Available Employees</label>
                                        <select class="form-control required" id="assigned_emp_id" name="assigned_emp_id" required>
